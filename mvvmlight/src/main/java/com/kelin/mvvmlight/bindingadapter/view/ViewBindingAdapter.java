...
public final class ViewBindingAdapter {
    ...
    public static void setActiveState(View view, boolean activeState) {
        view.setActivated(activeState);
    }

    @BindingAdapter({"enableState"})
    public static void setEnableState(View view, boolean enableState) {
